        ...
        <Box height={'113px'} bgColor='#fff' py='26px' px={{ base: '12px', md: '90px' }}>
            <Flex direction={'row'} justifyContent='space-between' py='auto'>
                <Link style={{ textDecoration: 'none' }} href='/HomePage'>
                    <Text my='auto' fontSize={{ base: '22px', md: '40px' }} fontWeight='700' fontFamily={'Poppins'} color='#3E38F5'>E-Mason</Text>
                </Link>
                <Flex dir='row' gap={{ base: '0px', md: '24px' }}>
                    <Link style={{ textDecoration: 'none' }} href='/negosiasiUserPage'>
                        <Text my='auto' fontSize={{ base: '18px', md: '24px' }} fontWeight='700' fontFamily={'Poppins'}>Negosiasi</Text>
                    </Link>
