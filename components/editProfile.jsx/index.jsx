import { Box, Button, Center, Flex, FormControl, FormLabel, HStack, Input, Stack, Text, VStack } from "@chakra-ui/react"
        ...
        <LayoutDashboardUser pageTitle={'Edit Profile'}>
            <Box  justifyContent={{md:'center', lg:'right'}}>
                ...
                <VStack spacing='15px' mt='34px'>
                    ...
                    <FormControl>
                        <Input type='usia' placeholder="Usia" />
                    </FormControl>
                    <FormControl>
                        <Input type='telp' placeholder="Nomor Telepon" />
                    </FormControl>
                    <FormControl>
                        <Input type='alamat' placeholder="Alamat" />
                    </FormControl>
                    <FormControl>
                        <Input type='keahlian' placeholder="Keahlian" />
                    </FormControl>
                </VStack>
