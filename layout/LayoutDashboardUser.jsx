import { Box, Flex, Hide, HStack, Link, Stack, Text } from "@chakra-ui/react"
...
const LayoutDashboardUser = ({pageTitle,children,bgColor,color}) => {
    return(
        ...
        <Box height={'auto'} bgColor={'#E9E8F9'} pb='40px'>
            <Navbar />
            <Flex direction={'row'} gap={{lg:'20px',xl:'89px'}} justifyContent={{md:'center', lg:'normal'}} textAlign='center'>
                <Hide below="lg">
