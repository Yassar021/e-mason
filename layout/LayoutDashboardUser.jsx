...
const LayoutDashboardUser = ({pageTitle,children}) => {
    return(
        <>
        <Head>
        ...
        <Box height={'auto'} bgColor={'#E9E8F9'} pb='40px'>
            ...
            <Flex direction={'row'} gap='89px'>
                <Box width={'389px'} height='100vh' bgColor={'#fff'} pt='57px' textAlign={'center'}>
                    ...
                    <hr />
                    <Box px='90px' py='15px'>
                        <Box py='8px' px='12px' width={'210px'} height='45px' bgColor='rgba(62, 56, 245, 0.3)' borderRadius={'5px'}>
                            <Link style={{textDecoration: 'none'}} href='/negosiasiUserPage'>
                            <Stack direction={'row'} spacing='12px'>
                                <Stack mt='4px'>
                                    <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 3C1 3 2.5 1 6 1C9.5 1 11 3 11 3V17C11 17 9.5 16 6 16C2.5 16 1 17 1 17V3ZM11 3C11 3 12.5 1 16 1C19.5 1 21 3 21 3V17C21 17 19.5 16 16 16C12.5 16 11 17 11 17V3Z" stroke="#3E38F5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </Stack>
                                <Text color={'#3E38F5'} fontSize={'20px'} fontWeight='600'>Negosiasi</Text>
                            </Stack>
                            </Link>
                        </Box>
                    </Box>
                    <hr />
                    <Box px='90px' py='15px'>
                        <Box py='8px' px='12px' width={'210px'} height='45px' borderRadius={'5px'}>
                            <Link style={{textDecoration: 'none'}} href='/negosiasiUserPage'>
                            <Stack direction={'row'} spacing='12px'>
                                <Stack mt='4px'>
                                ...
                                <Text fontSize={'20px'} fontWeight='600'>Ubah Profile</Text>
                            </Stack>
                            </Link>
                        </Box>
                    </Box>
                ...
                <Box mt='40px' bgColor={'#ffff'} pt='28px' px='57px' width={'auto'} height='498px' borderRadius='8px'>
                    {children}
                </Box>
            </Flex>
        </Box>
