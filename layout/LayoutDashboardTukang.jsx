                ...
                <Flex direction={'row'} pr={{ lg: '20px', xl: '89px' }} gap={{ lg: '20px', xl: '89px' }} justifyContent={{ md: 'center', lg: 'normal' }} textAlign='center'>
                    <Box width={{ lg: '280px', xl: '389px' }} minHeight='100vh' height={'auto'} bgColor={'#fff'} pt='57px' textAlign={'center'}>
                        <Hide below="md">
                            ...
                            <Box px={{ lg: '40px', xl: '90px' }} py='15px'>
                                <Box py='8px' px='12px' width={'210px'} height='45px' bgColor={bgColor} borderRadius={'5px'}>
                                    <Link style={{ textDecoration: 'none' }} href='/editProfileTukangPage'>
                                        <Stack direction={'row'} spacing='12px'>
                                            <Stack mt='4px'>
                            ...
                            <Box px={{ lg: '40px', xl: '90px' }} py='15px'>
                                <Box py='8px' px='12px' width={'210px'} height='45px' bgColor={bgColor} borderRadius={'5px'}>
                                    <Link style={{ textDecoration: 'none' }} href='/portfolioTukang'>
                                        <Stack direction={'row'} spacing='12px'>
                                            <Stack mt='4px'>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="5" y="4" width="14" height="17" rx="2" stroke="#000000" strokeWidth="2" />
                                                    <path d="M9 9H15" stroke="#000000" strokeWidth="2" strokeLinecap="round" />
                                                    <path d="M9 13H15" stroke="#000000" strokeWidth="2" strokeLinecap="round" />
                                                    <path d="M9 17H13" stroke="#000000" strokeWidth="2" strokeLinecap="round" />
                                                </svg>
                                            </Stack>
                                            <Text color={color} fontSize={'20px'} fontWeight='600'>Portofolio</Text>
                                        </Stack>
                                    </Link>
                                </Box>
                            </Box>
...
export default LayoutDashboardTukang